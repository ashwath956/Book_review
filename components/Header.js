...
class Header extends React.Component {
  ...
  renderRight = () => {
    ...
    switch (title) {
      case 'Home':
        return [
          <BellButton key="chat-home" navigation={navigation} isWhite={white} style={styles.Bell} />,
  ...
  renderOptions = () => {
    ...
    return (
      <Block row style={styles.options}>
        ...
        <Button shadowless style={styles.tab} onPress={() => navigation.navigate('Articles')}>
          <Block row middle>
            <Icon
              size={18}
              name="paper2x"
