  ...
  return (
    ...
    >
      <Block style={styles.header}>
        {/* <Image style={styles.logo} source={Images.NowLogo} /> */}
      ...
      <Block flex style={{ paddingLeft: 8, paddingRight: 15 }}>
        <ScrollView style={{ flex: 1 }} showsVerticalScrollIndicator={false}>
          ...
          <Block flex style={{ marginTop: 25, marginVertical: 8, paddingHorizontal: 8 }}>
          <Block
